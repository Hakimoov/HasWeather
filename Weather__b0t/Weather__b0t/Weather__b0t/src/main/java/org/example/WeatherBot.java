...
public class WeatherBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage()){
            String userName = update.getMessage().getChat().getLastName();
            ...
            if (update.getMessage().hasLocation() || locationMap.get(chatId) != null){
                ...
                String message = "----------------\n" +
                        ...
                        + currentWeather.getWeather().get(0).getMain() + "/n" +
                        "-------------------- ";
            ...
            switch (text){
                case "/start":
                    sendMessage.setText("Salom" + userName + "\nServisdan foydalanish uchun locatsiyani yuboring");
                    ...
                    break;
                case "1":
                    sendMessage.setText("Siz bir deb yozdingiz" + userName);
                    executeMessage(sendMessage);
                    break;
